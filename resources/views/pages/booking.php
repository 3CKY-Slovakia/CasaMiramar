			...
			<div class="row">
				<div class="col-lg-10 col-lg-offset-1">
					...
					<nav class="nav row">
						...
						<div class="col-sm-2">
							<h1 class="logo"><a href="{{ url('/') }}"><img src="images/dummy/logo_white.png" alt=""></a></h1>
						</div>
						...
						<div class="col-sm-5">
							<ul class="navigation right-nav">
								...
								<li class='current'><a class='current' href="{{ url('booking') }}">Booking</a></li>
					...
					<div id="mobilemenu">
						<ul>
							...
							<li class='current'><a class='current' href="{{ url('booking') }}">Booking Page</a></li>
							<li><a href="gallery-single.html">Galleries</a></li>
							<li><a href="{{ url('contact') }}">Contact</a></li>
						</ul>
					</div>
			...
			<div class="row">
				<div class="col-lg-10 col-lg-offset-1">
					...
					<nav class="nav row">
						...
						<div class="col-sm-2">
							<div class="logo"><a href="{{ url('/') }}"><img src="images/dummy/logo_grey.png" alt=""></a></div>
						</div>
					...
					<p class="credits">Made in 3cky.com</p>
				</div>
			</div>
		</div>
	</footer>
